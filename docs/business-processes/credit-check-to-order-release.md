---
title: Credit Check to Order Release
category: Customer & Revenue
processId: BP-017
---

# Credit Check to Order Release
...
![Credit Check to Order Release workflow](./diagrams/credit-check-to-order-release.svg)

## Primary workflow

| Step | Workflow stage | Suggested RDF role |
|---:|---|---|
| 1 | Credit Check | `credit_check` |
...
- `credit_check` → process step candidate
...
- `order_release` → process step candidate
...
bp:creditchecktoorderrelease a ng:BusinessProcessPattern ;
  ng:processId "BP-017" ;
  ng:domain "Customer & Revenue" ;
  rdfs:label "Credit Check to Order Release" .
```
