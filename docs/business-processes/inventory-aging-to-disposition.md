---
title: Inventory Aging to Disposition
category: Inventory & Logistics
processId: BP-054
---

# Inventory Aging to Disposition
...
![Inventory Aging to Disposition workflow](./diagrams/inventory-aging-to-disposition.svg)

## Primary workflow

| Step | Workflow stage | Suggested RDF role |
|---:|---|---|
| 1 | Inventory Aging | `inventory_aging` |
...
- `inventory_aging` → process step candidate
...
- `disposition` → process step candidate
...
bp:inventoryagingtodisposition a ng:BusinessProcessPattern ;
  ng:processId "BP-054" ;
  ng:domain "Inventory & Logistics" ;
  rdfs:label "Inventory Aging to Disposition" .
```
