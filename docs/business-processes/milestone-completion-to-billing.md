---
title: Milestone Completion to Billing
category: Projects & Services
processId: BP-109
---

# Milestone Completion to Billing
...
![Milestone Completion to Billing workflow](./diagrams/milestone-completion-to-billing.svg)

## Primary workflow

| Step | Workflow stage | Suggested RDF role |
|---:|---|---|
| 1 | Milestone Completion | `milestone_completion` |
...
- `milestone_completion` → process step candidate
...
bp:milestonecompletiontobilling a ng:BusinessProcessPattern ;
  ng:processId "BP-109" ;
  ng:domain "Projects & Services" ;
  rdfs:label "Milestone Completion to Billing" .
```
