---
title: Procurement Closure to Archive
category: Procurement & Supplier
processId: BP-036
---

# Procurement Closure to Archive
...
![Procurement Closure to Archive workflow](./diagrams/procurement-closure-to-archive.svg)

## Primary workflow

| Step | Workflow stage | Suggested RDF role |
|---:|---|---|
| 1 | Procurement Closure | `procurement_closure` |
...
- `procurement_closure` → process step candidate
...
- `archive` → process step candidate
...
bp:procurementclosuretoarchive a ng:BusinessProcessPattern ;
  ng:processId "BP-036" ;
  ng:domain "Procurement & Supplier" ;
  rdfs:label "Procurement Closure to Archive" .
```
