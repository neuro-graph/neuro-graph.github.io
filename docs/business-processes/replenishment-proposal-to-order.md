---
title: Replenishment Proposal to Order
category: Planning & Supply Chain
processId: BP-135
---

# Replenishment Proposal to Order
...
![Replenishment Proposal to Order workflow](./diagrams/replenishment-proposal-to-order.svg)

## Primary workflow

| Step | Workflow stage | Suggested RDF role |
|---:|---|---|
| 1 | Replenishment Proposal | `replenishment_proposal` |
...
- `replenishment_proposal` → process step candidate
...
bp:replenishmentproposaltoorder a ng:BusinessProcessPattern ;
  ng:processId "BP-135" ;
  ng:domain "Planning & Supply Chain" ;
  rdfs:label "Replenishment Proposal to Order" .
```
