---
title: Forecast Consumption to Rebalance
category: Planning & Supply Chain
processId: BP-139
---

# Forecast Consumption to Rebalance
...
![Forecast Consumption to Rebalance workflow](./diagrams/forecast-consumption-to-rebalance.svg)

## Primary workflow

| Step | Workflow stage | Suggested RDF role |
|---:|---|---|
| 1 | Forecast Consumption | `forecast_consumption` |
...
- `forecast_consumption` → process step candidate
...
- `rebalance` → process step candidate
...
bp:forecastconsumptiontorebalance a ng:BusinessProcessPattern ;
  ng:processId "BP-139" ;
  ng:domain "Planning & Supply Chain" ;
  rdfs:label "Forecast Consumption to Rebalance" .
```
