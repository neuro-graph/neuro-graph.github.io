---
title: Employee Offboarding to Deactivation
category: Workforce & HR
processId: BP-128
---

# Employee Offboarding to Deactivation
...
![Employee Offboarding to Deactivation workflow](./diagrams/employee-offboarding-to-deactivation.svg)

## Primary workflow

| Step | Workflow stage | Suggested RDF role |
|---:|---|---|
| 1 | Employee Offboarding | `employee_offboarding` |
...
- `employee_offboarding` → process step candidate
...
- `deactivation` → process step candidate
...
bp:employeeoffboardingtodeactivation a ng:BusinessProcessPattern ;
  ng:processId "BP-128" ;
  ng:domain "Workforce & HR" ;
  rdfs:label "Employee Offboarding to Deactivation" .
```
