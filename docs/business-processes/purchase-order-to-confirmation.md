---
title: Purchase Order to Confirmation
category: Procurement & Supplier
processId: BP-024
---

# Purchase Order to Confirmation
...
![Purchase Order to Confirmation workflow](./diagrams/purchase-order-to-confirmation.svg)
...
bp:purchaseordertoconfirmation a ng:BusinessProcessPattern ;
  ng:processId "BP-024" ;
  ng:domain "Procurement & Supplier" ;
  rdfs:label "Purchase Order to Confirmation" .
```
