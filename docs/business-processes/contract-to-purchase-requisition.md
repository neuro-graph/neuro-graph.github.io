---
title: Contract to Purchase Requisition
...
![Contract to Purchase Requisition workflow](./diagrams/contract-to-purchase-requisition.svg)
...
| 6 | Purchase Requisition | `purchase_requisition` |
...
bp:contracttopurchaserequisition a ng:BusinessProcessPattern ;
  ng:processId "BP-022" ;
  ng:domain "Procurement & Supplier" ;
  rdfs:label "Contract to Purchase Requisition" .
```
