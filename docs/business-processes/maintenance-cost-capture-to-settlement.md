---
title: Maintenance Cost Capture to Settlement
category: Assets & Maintenance
processId: BP-102
---

# Maintenance Cost Capture to Settlement
...
![Maintenance Cost Capture to Settlement workflow](./diagrams/maintenance-cost-capture-to-settlement.svg)

## Primary workflow

| Step | Workflow stage | Suggested RDF role |
|---:|---|---|
| 1 | Maintenance Cost Capture | `maintenance_cost_capture` |
...
- `maintenance_cost_capture` → process step candidate
...
bp:maintenancecostcapturetosettlement a ng:BusinessProcessPattern ;
  ng:processId "BP-102" ;
  ng:domain "Assets & Maintenance" ;
  rdfs:label "Maintenance Cost Capture to Settlement" .
```
