---
title: Allocation Planning to Fulfillment
category: Planning & Supply Chain
processId: BP-136
---

# Allocation Planning to Fulfillment
...
![Allocation Planning to Fulfillment workflow](./diagrams/allocation-planning-to-fulfillment.svg)

## Primary workflow

| Step | Workflow stage | Suggested RDF role |
|---:|---|---|
| 1 | Allocation Planning | `allocation_planning` |
...
- `allocation_planning` → process step candidate
...
- `fulfillment` → process step candidate
...
bp:allocationplanningtofulfillment a ng:BusinessProcessPattern ;
  ng:processId "BP-136" ;
  ng:domain "Planning & Supply Chain" ;
  rdfs:label "Allocation Planning to Fulfillment" .
```
