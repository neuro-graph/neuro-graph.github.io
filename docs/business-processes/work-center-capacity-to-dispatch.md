---
title: Work Center Capacity to Dispatch
category: Manufacturing & Operations
processId: BP-067
---

# Work Center Capacity to Dispatch
...
![Work Center Capacity to Dispatch workflow](./diagrams/work-center-capacity-to-dispatch.svg)

## Primary workflow

| Step | Workflow stage | Suggested RDF role |
|---:|---|---|
| 1 | Work Center Capacity | `work_center_capacity` |
...
- `work_center_capacity` → process step candidate
...
bp:workcentercapacitytodispatch a ng:BusinessProcessPattern ;
  ng:processId "BP-067" ;
  ng:domain "Manufacturing & Operations" ;
  rdfs:label "Work Center Capacity to Dispatch" .
```
