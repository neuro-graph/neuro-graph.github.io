---
title: Payroll Preparation to Payment
category: Workforce & HR
processId: BP-125
---

# Payroll Preparation to Payment
...
![Payroll Preparation to Payment workflow](./diagrams/payroll-preparation-to-payment.svg)

## Primary workflow

| Step | Workflow stage | Suggested RDF role |
|---:|---|---|
| 1 | Payroll Preparation | `payroll_preparation` |
...
- `payroll_preparation` → process step candidate
...
- `payment` → process step candidate
...
bp:payrollpreparationtopayment a ng:BusinessProcessPattern ;
  ng:processId "BP-125" ;
  ng:domain "Workforce & HR" ;
  rdfs:label "Payroll Preparation to Payment" .
```
