---
title: Commitment Tracking to Actuals
category: Finance & Controlling
processId: BP-088
---

# Commitment Tracking to Actuals
...
![Commitment Tracking to Actuals workflow](./diagrams/commitment-tracking-to-actuals.svg)

## Primary workflow

| Step | Workflow stage | Suggested RDF role |
|---:|---|---|
| 1 | Commitment Tracking | `commitment_tracking` |
...
- `commitment_tracking` → process step candidate
...
- `actuals` → process step candidate
...
bp:commitmenttrackingtoactuals a ng:BusinessProcessPattern ;
  ng:processId "BP-088" ;
  ng:domain "Finance & Controlling" ;
  rdfs:label "Commitment Tracking to Actuals" .
```
