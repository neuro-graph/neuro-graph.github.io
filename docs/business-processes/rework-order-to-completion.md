---
title: Rework Order to Completion
category: Manufacturing & Operations
processId: BP-069
---

# Rework Order to Completion
...
![Rework Order to Completion workflow](./diagrams/rework-order-to-completion.svg)

## Primary workflow

| Step | Workflow stage | Suggested RDF role |
|---:|---|---|
| 1 | Rework Order | `rework_order` |
...
- `rework_order` → process step candidate
...
bp:reworkordertocompletion a ng:BusinessProcessPattern ;
  ng:processId "BP-069" ;
  ng:domain "Manufacturing & Operations" ;
  rdfs:label "Rework Order to Completion" .
```
