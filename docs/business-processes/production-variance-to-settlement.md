---
title: Production Variance to Settlement
category: Manufacturing & Operations
processId: BP-061
---

# Production Variance to Settlement
...
![Production Variance to Settlement workflow](./diagrams/production-variance-to-settlement.svg)

## Primary workflow

| Step | Workflow stage | Suggested RDF role |
|---:|---|---|
| 1 | Production Variance | `production_variance` |
...
- `production_variance` → process step candidate
...
bp:productionvariancetosettlement a ng:BusinessProcessPattern ;
  ng:processId "BP-061" ;
  ng:domain "Manufacturing & Operations" ;
  rdfs:label "Production Variance to Settlement" .
```
