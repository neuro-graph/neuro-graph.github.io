---
title: Meter Reading to Maintenance Trigger
category: Assets & Maintenance
processId: BP-101
---

# Meter Reading to Maintenance Trigger
...
![Meter Reading to Maintenance Trigger workflow](./diagrams/meter-reading-to-maintenance-trigger.svg)

## Primary workflow

| Step | Workflow stage | Suggested RDF role |
|---:|---|---|
| 1 | Meter Reading | `meter_reading` |
...
| 6 | Maintenance Trigger | `maintenance_trigger` |
...
- `meter_reading` → process step candidate
...
- `maintenance_trigger` → process step candidate
...
bp:meterreadingtomaintenancetrigger a ng:BusinessProcessPattern ;
  ng:processId "BP-101" ;
  ng:domain "Assets & Maintenance" ;
  rdfs:label "Meter Reading to Maintenance Trigger" .
```
