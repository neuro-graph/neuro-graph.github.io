---
title: Material Request to Reservation
category: Inventory & Logistics
processId: BP-037
---

# Material Request to Reservation
...
![Material Request to Reservation workflow](./diagrams/material-request-to-reservation.svg)
...
- `material_request` → process step candidate
...
- `reservation` → process step candidate
...
bp:materialrequesttoreservation a ng:BusinessProcessPattern ;
  ng:processId "BP-037" ;
  ng:domain "Inventory & Logistics" ;
  rdfs:label "Material Request to Reservation" .
```
