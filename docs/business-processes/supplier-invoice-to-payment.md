...
![Supplier Invoice to Payment workflow](./diagrams/supplier-invoice-to-payment.svg)

## Primary workflow

| Step | Workflow stage | Suggested RDF role |
|---:|---|---|
| 1 | Supplier Invoice | `supplier_invoice` |
...
bp:supplierinvoicetopayment a ng:BusinessProcessPattern ;
  ng:processId "BP-027" ;
  ng:domain "Procurement & Supplier" ;
  rdfs:label "Supplier Invoice to Payment" .
```
