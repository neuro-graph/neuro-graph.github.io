---
title: Capacity Planning to Constraint Resolution
category: Planning & Supply Chain
processId: BP-137
---

# Capacity Planning to Constraint Resolution
...
![Capacity Planning to Constraint Resolution workflow](./diagrams/capacity-planning-to-constraint-resolution.svg)

## Primary workflow

| Step | Workflow stage | Suggested RDF role |
|---:|---|---|
| 1 | Capacity Planning | `capacity_planning` |
...
| 6 | Constraint Resolution | `constraint_resolution` |
...
- `capacity_planning` → process step candidate
...
- `constraint_resolution` → process step candidate
...
bp:capacityplanningtoconstraintresolution a ng:BusinessProcessPattern ;
  ng:processId "BP-137" ;
  ng:domain "Planning & Supply Chain" ;
  rdfs:label "Capacity Planning to Constraint Resolution" .
```
