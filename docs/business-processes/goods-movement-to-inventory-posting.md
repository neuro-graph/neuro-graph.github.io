---
title: Goods Movement to Inventory Posting
category: Inventory & Logistics
processId: BP-041
---

# Goods Movement to Inventory Posting
...
![Goods Movement to Inventory Posting workflow](./diagrams/goods-movement-to-inventory-posting.svg)

## Primary workflow

| Step | Workflow stage | Suggested RDF role |
|---:|---|---|
| 1 | Goods Movement | `goods_movement` |
...
| 6 | Inventory Posting | `inventory_posting` |
...
- `goods_movement` → process step candidate
...
- `inventory_posting` → process step candidate
...
bp:goodsmovementtoinventoryposting a ng:BusinessProcessPattern ;
  ng:processId "BP-041" ;
  ng:domain "Inventory & Logistics" ;
  rdfs:label "Goods Movement to Inventory Posting" .
```
