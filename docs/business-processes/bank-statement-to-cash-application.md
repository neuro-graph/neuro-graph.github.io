---
title: Bank Statement to Cash Application
category: Finance & Controlling
processId: BP-079
---

# Bank Statement to Cash Application
...
![Bank Statement to Cash Application workflow](./diagrams/bank-statement-to-cash-application.svg)
...
- `cash_application` → process step candidate
...
bp:bankstatementtocashapplication a ng:BusinessProcessPattern ;
  ng:processId "BP-079" ;
  ng:domain "Finance & Controlling" ;
  rdfs:label "Bank Statement to Cash Application" .
```
