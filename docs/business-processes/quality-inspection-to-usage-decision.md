---
title: Quality Inspection to Usage Decision
category: Manufacturing & Operations
processId: BP-060
---

# Quality Inspection to Usage Decision
...
![Quality Inspection to Usage Decision workflow](./diagrams/quality-inspection-to-usage-decision.svg)

## Primary workflow

| Step | Workflow stage | Suggested RDF role |
|---:|---|---|
| 1 | Quality Inspection | `quality_inspection` |
...
| 6 | Usage Decision | `usage_decision` |
...
- `quality_inspection` → process step candidate
...
- `usage_decision` → process step candidate
...
bp:qualityinspectiontousagedecision a ng:BusinessProcessPattern ;
  ng:processId "BP-060" ;
  ng:domain "Manufacturing & Operations" ;
  rdfs:label "Quality Inspection to Usage Decision" .
```
