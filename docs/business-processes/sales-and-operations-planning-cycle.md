---
title: Sales and Operations Planning Cycle
...
![Sales and Operations Planning Cycle workflow](./diagrams/sales-and-operations-planning-cycle.svg)
...
- `request` → process step candidate
...
bp:salesandoperationsplanningcycle a ng:BusinessProcessPattern ;
  ng:processId "BP-133" ;
  ng:domain "Planning & Supply Chain" ;
  rdfs:label "Sales and Operations Planning Cycle" .
```
