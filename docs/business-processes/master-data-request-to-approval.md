---
title: Master Data Request to Approval
category: Governance Risk Data
processId: BP-147
---

# Master Data Request to Approval
...
![Master Data Request to Approval workflow](./diagrams/master-data-request-to-approval.svg)

## Primary workflow

| Step | Workflow stage | Suggested RDF role |
|---:|---|---|
| 1 | Master Data Request | `master_data_request` |
...
- `master_data_request` → process step candidate
...
bp:masterdatarequesttoapproval a ng:BusinessProcessPattern ;
  ng:processId "BP-147" ;
  ng:domain "Governance Risk Data" ;
  rdfs:label "Master Data Request to Approval" .
```
