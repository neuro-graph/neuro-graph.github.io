---
title: Workforce Request to Job Requisition
category: Workforce & HR
processId: BP-117
---

# Workforce Request to Job Requisition
...
![Workforce Request to Job Requisition workflow](./diagrams/workforce-request-to-job-requisition.svg)

## Primary workflow

| Step | Workflow stage | Suggested RDF role |
|---:|---|---|
| 1 | Workforce Request | `workforce_request` |
...
| 6 | Job Requisition | `job_requisition` |
...
- `workforce_request` → process step candidate
...
- `job_requisition` → process step candidate
...
bp:workforcerequesttojobrequisition a ng:BusinessProcessPattern ;
  ng:processId "BP-117" ;
  ng:domain "Workforce & HR" ;
  rdfs:label "Workforce Request to Job Requisition" .
```
