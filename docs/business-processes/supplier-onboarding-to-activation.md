---
title: Supplier Onboarding to Activation
...
![Supplier Onboarding to Activation workflow](./diagrams/supplier-onboarding-to-activation.svg)

## Primary workflow

| Step | Workflow stage | Suggested RDF role |
|---:|---|---|
| 1 | Supplier Onboarding | `supplier_onboarding` |
...
- `supplier_onboarding` → process step candidate
...
bp:supplieronboardingtoactivation a ng:BusinessProcessPattern ;
  ng:processId "BP-020" ;
  ng:domain "Procurement & Supplier" ;
  rdfs:label "Supplier Onboarding to Activation" .
```
