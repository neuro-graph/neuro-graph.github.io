---
title: Supplier Discovery to Qualification
category: Procurement & Supplier
processId: BP-019
---

# Supplier Discovery to Qualification
...
![Supplier Discovery to Qualification workflow](./diagrams/supplier-discovery-to-qualification.svg)

## Primary workflow

| Step | Workflow stage | Suggested RDF role |
|---:|---|---|
| 1 | Supplier Discovery | `supplier_discovery` |
...
- `supplier_discovery` → process step candidate
...
- `qualification` → process step candidate
...
bp:supplierdiscoverytoqualification a ng:BusinessProcessPattern ;
  ng:processId "BP-019" ;
  ng:domain "Procurement & Supplier" ;
  rdfs:label "Supplier Discovery to Qualification" .
```
