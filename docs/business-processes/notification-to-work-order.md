---
title: Notification to Work Order
category: Assets & Maintenance
processId: BP-094
---

# Notification to Work Order
...
![Notification to Work Order workflow](./diagrams/notification-to-work-order.svg)
...
- `work_order` → process step candidate
...
bp:notificationtoworkorder a ng:BusinessProcessPattern ;
  ng:processId "BP-094" ;
  ng:domain "Assets & Maintenance" ;
  rdfs:label "Notification to Work Order" .
```
