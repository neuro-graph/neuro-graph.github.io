---
title: Maintenance Request to Notification
category: Assets & Maintenance
processId: BP-093
---

# Maintenance Request to Notification
...
![Maintenance Request to Notification workflow](./diagrams/maintenance-request-to-notification.svg)

## Primary workflow

| Step | Workflow stage | Suggested RDF role |
|---:|---|---|
| 1 | Maintenance Request | `maintenance_request` |
...
- `maintenance_request` → process step candidate
...
- `notification` → process step candidate
...
bp:maintenancerequesttonotification a ng:BusinessProcessPattern ;
  ng:processId "BP-093" ;
  ng:domain "Assets & Maintenance" ;
  rdfs:label "Maintenance Request to Notification" .
```
