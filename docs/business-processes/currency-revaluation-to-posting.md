---
title: Currency Revaluation to Posting
category: Finance & Controlling
processId: BP-092
---

# Currency Revaluation to Posting
...
![Currency Revaluation to Posting workflow](./diagrams/currency-revaluation-to-posting.svg)

## Primary workflow

| Step | Workflow stage | Suggested RDF role |
|---:|---|---|
| 1 | Currency Revaluation | `currency_revaluation` |
...
- `currency_revaluation` → process step candidate
...
bp:currencyrevaluationtoposting a ng:BusinessProcessPattern ;
  ng:processId "BP-092" ;
  ng:domain "Finance & Controlling" ;
  rdfs:label "Currency Revaluation to Posting" .
```
