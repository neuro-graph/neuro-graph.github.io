---
title: Project Proposal to Approval
...
![Project Proposal to Approval workflow](./diagrams/project-proposal-to-approval.svg)

## Primary workflow

| Step | Workflow stage | Suggested RDF role |
|---:|---|---|
| 1 | Project Proposal | `project_proposal` |
...
- `project_proposal` → process step candidate
...
bp:projectproposaltoapproval a ng:BusinessProcessPattern ;
  ng:processId "BP-105" ;
  ng:domain "Projects & Services" ;
  rdfs:label "Project Proposal to Approval" .
```
