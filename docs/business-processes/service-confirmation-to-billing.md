---
title: Service Confirmation to Billing
category: Projects & Services
processId: BP-113
---

# Service Confirmation to Billing
...
![Service Confirmation to Billing workflow](./diagrams/service-confirmation-to-billing.svg)

## Primary workflow

| Step | Workflow stage | Suggested RDF role |
|---:|---|---|
| 1 | Service Confirmation | `service_confirmation` |
...
- `service_confirmation` → process step candidate
...
bp:serviceconfirmationtobilling a ng:BusinessProcessPattern ;
  ng:processId "BP-113" ;
  ng:domain "Projects & Services" ;
  rdfs:label "Service Confirmation to Billing" .
```
