...
![Make to Order Production workflow](./diagrams/make-to-order-production.svg)
...
| 6 | Order Production | `order_production` |
...
- `order_production` → process step candidate
...
bp:maketoorderproduction a ng:BusinessProcessPattern ;
  ng:processId "BP-063" ;
  ng:domain "Manufacturing & Operations" ;
  rdfs:label "Make to Order Production" .
```
