---
title: Catalog Request to Order
category: Procurement & Supplier
processId: BP-031
---

# Catalog Request to Order
...
![Catalog Request to Order workflow](./diagrams/catalog-request-to-order.svg)

## Primary workflow

| Step | Workflow stage | Suggested RDF role |
|---:|---|---|
| 1 | Catalog Request | `catalog_request` |
...
- `catalog_request` → process step candidate
...
bp:catalogrequesttoorder a ng:BusinessProcessPattern ;
  ng:processId "BP-031" ;
  ng:domain "Procurement & Supplier" ;
  rdfs:label "Catalog Request to Order" .
```
