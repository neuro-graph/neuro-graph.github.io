---
title: Price Determination to Approval
category: Customer & Revenue
processId: BP-018
---

# Price Determination to Approval
...
![Price Determination to Approval workflow](./diagrams/price-determination-to-approval.svg)

## Primary workflow

| Step | Workflow stage | Suggested RDF role |
|---:|---|---|
| 1 | Price Determination | `price_determination` |
...
- `price_determination` → process step candidate
...
bp:pricedeterminationtoapproval a ng:BusinessProcessPattern ;
  ng:processId "BP-018" ;
  ng:domain "Customer & Revenue" ;
  rdfs:label "Price Determination to Approval" .
```
