---
title: Spare Part Reservation to Issue
category: Assets & Maintenance
processId: BP-097
---

# Spare Part Reservation to Issue
...
![Spare Part Reservation to Issue workflow](./diagrams/spare-part-reservation-to-issue.svg)

## Primary workflow

| Step | Workflow stage | Suggested RDF role |
|---:|---|---|
| 1 | Spare Part Reservation | `spare_part_reservation` |
...
- `spare_part_reservation` → process step candidate
...
bp:sparepartreservationtoissue a ng:BusinessProcessPattern ;
  ng:processId "BP-097" ;
  ng:domain "Assets & Maintenance" ;
  rdfs:label "Spare Part Reservation to Issue" .
```
