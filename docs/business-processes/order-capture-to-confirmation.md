---
title: Order Capture to Confirmation
category: Customer & Revenue
processId: BP-006
---

# Order Capture to Confirmation
...
![Order Capture to Confirmation workflow](./diagrams/order-capture-to-confirmation.svg)

## Primary workflow

| Step | Workflow stage | Suggested RDF role |
|---:|---|---|
| 1 | Order Capture | `order_capture` |
...
- `order_capture` → process step candidate
...
bp:ordercapturetoconfirmation a ng:BusinessProcessPattern ;
  ng:processId "BP-006" ;
  ng:domain "Customer & Revenue" ;
  rdfs:label "Order Capture to Confirmation" .
```
