---
title: Demand Signal to Production Plan
category: Manufacturing & Operations
processId: BP-055
---

# Demand Signal to Production Plan
...
![Demand Signal to Production Plan workflow](./diagrams/demand-signal-to-production-plan.svg)

## Primary workflow

| Step | Workflow stage | Suggested RDF role |
|---:|---|---|
| 1 | Demand Signal | `demand_signal` |
...
| 6 | Production Plan | `production_plan` |
...
- `demand_signal` → process step candidate
...
- `production_plan` → process step candidate
...
bp:demandsignaltoproductionplan a ng:BusinessProcessPattern ;
  ng:processId "BP-055" ;
  ng:domain "Manufacturing & Operations" ;
  rdfs:label "Demand Signal to Production Plan" .
```
