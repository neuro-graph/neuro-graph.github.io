---
title: Learning Assignment to Completion
category: Workforce & HR
processId: BP-127
---

# Learning Assignment to Completion
...
![Learning Assignment to Completion workflow](./diagrams/learning-assignment-to-completion.svg)

## Primary workflow

| Step | Workflow stage | Suggested RDF role |
|---:|---|---|
| 1 | Learning Assignment | `learning_assignment` |
...
- `learning_assignment` → process step candidate
...
- `completion` → process step candidate
...
bp:learningassignmenttocompletion a ng:BusinessProcessPattern ;
  ng:processId "BP-127" ;
  ng:domain "Workforce & HR" ;
  rdfs:label "Learning Assignment to Completion" .
```
