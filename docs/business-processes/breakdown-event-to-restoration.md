---
title: Breakdown Event to Restoration
category: Assets & Maintenance
processId: BP-098
---

# Breakdown Event to Restoration
...
![Breakdown Event to Restoration workflow](./diagrams/breakdown-event-to-restoration.svg)

## Primary workflow

| Step | Workflow stage | Suggested RDF role |
|---:|---|---|
| 1 | Breakdown Event | `breakdown_event` |
...
- `breakdown_event` → process step candidate
...
- `restoration` → process step candidate
...
bp:breakdowneventtorestoration a ng:BusinessProcessPattern ;
  ng:processId "BP-098" ;
  ng:domain "Assets & Maintenance" ;
  rdfs:label "Breakdown Event to Restoration" .
```
