---
title: Physical Inventory to Reconciliation
category: Inventory & Logistics
processId: BP-043
---

# Physical Inventory to Reconciliation
...
![Physical Inventory to Reconciliation workflow](./diagrams/physical-inventory-to-reconciliation.svg)

## Primary workflow

| Step | Workflow stage | Suggested RDF role |
|---:|---|---|
| 1 | Physical Inventory | `physical_inventory` |
...
- `physical_inventory` → process step candidate
...
bp:physicalinventorytoreconciliation a ng:BusinessProcessPattern ;
  ng:processId "BP-043" ;
  ng:domain "Inventory & Logistics" ;
  rdfs:label "Physical Inventory to Reconciliation" .
```
