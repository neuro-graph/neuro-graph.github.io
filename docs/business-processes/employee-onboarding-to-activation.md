---
title: Employee Onboarding to Activation
category: Workforce & HR
processId: BP-121
---

# Employee Onboarding to Activation
...
![Employee Onboarding to Activation workflow](./diagrams/employee-onboarding-to-activation.svg)

## Primary workflow

| Step | Workflow stage | Suggested RDF role |
|---:|---|---|
| 1 | Employee Onboarding | `employee_onboarding` |
...
- `employee_onboarding` → process step candidate
...
- `activation` → process step candidate
...
bp:employeeonboardingtoactivation a ng:BusinessProcessPattern ;
  ng:processId "BP-121" ;
  ng:domain "Workforce & HR" ;
  rdfs:label "Employee Onboarding to Activation" .
```
