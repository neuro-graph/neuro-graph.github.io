---
title: Asset Acquisition to Capitalization
...
![Asset Acquisition to Capitalization workflow](./diagrams/asset-acquisition-to-capitalization.svg)

## Primary workflow

| Step | Workflow stage | Suggested RDF role |
|---:|---|---|
| 1 | Asset Acquisition | `asset_acquisition` |
...
| 6 | Capitalization | `capitalization` |
...
- `asset_acquisition` → process step candidate
...
- `capitalization` → process step candidate
...
bp:assetacquisitiontocapitalization a ng:BusinessProcessPattern ;
  ng:processId "BP-084" ;
  ng:domain "Finance & Controlling" ;
  rdfs:label "Asset Acquisition to Capitalization" .
```
