---
title: Equipment Installation to Decommissioning
category: Assets & Maintenance
processId: BP-104
---

# Equipment Installation to Decommissioning
...
![Equipment Installation to Decommissioning workflow](./diagrams/equipment-installation-to-decommissioning.svg)

## Primary workflow

| Step | Workflow stage | Suggested RDF role |
|---:|---|---|
| 1 | Equipment Installation | `equipment_installation` |
...
| 6 | Decommissioning | `decommissioning` |
...
- `equipment_installation` → process step candidate
...
- `decommissioning` → process step candidate
...
bp:equipmentinstallationtodecommissioning a ng:BusinessProcessPattern ;
  ng:processId "BP-104" ;
  ng:domain "Assets & Maintenance" ;
  rdfs:label "Equipment Installation to Decommissioning" .
```
