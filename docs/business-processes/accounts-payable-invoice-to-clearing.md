---
title: Accounts Payable Invoice to Clearing
category: Finance & Controlling
processId: BP-075
---

# Accounts Payable Invoice to Clearing
...
![Accounts Payable Invoice to Clearing workflow](./diagrams/accounts-payable-invoice-to-clearing.svg)

## Primary workflow

| Step | Workflow stage | Suggested RDF role |
|---:|---|---|
| 1 | Accounts Payable Invoice | `accounts_payable_invoice` |
...
- `accounts_payable_invoice` → process step candidate
...
bp:accountspayableinvoicetoclearing a ng:BusinessProcessPattern ;
  ng:processId "BP-075" ;
  ng:domain "Finance & Controlling" ;
  rdfs:label "Accounts Payable Invoice to Clearing" .
```
