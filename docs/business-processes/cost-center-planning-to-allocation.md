---
title: Cost Center Planning to Allocation
category: Finance & Controlling
processId: BP-081
---

# Cost Center Planning to Allocation
...
![Cost Center Planning to Allocation workflow](./diagrams/cost-center-planning-to-allocation.svg)

## Primary workflow

| Step | Workflow stage | Suggested RDF role |
|---:|---|---|
| 1 | Cost Center Planning | `cost_center_planning` |
...
- `cost_center_planning` → process step candidate
...
- `allocation` → process step candidate
...
bp:costcenterplanningtoallocation a ng:BusinessProcessPattern ;
  ng:processId "BP-081" ;
  ng:domain "Finance & Controlling" ;
  rdfs:label "Cost Center Planning to Allocation" .
```
