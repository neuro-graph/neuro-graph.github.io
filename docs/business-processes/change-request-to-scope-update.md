---
title: Change Request to Scope Update
category: Projects & Services
processId: BP-115
---

# Change Request to Scope Update
...
![Change Request to Scope Update workflow](./diagrams/change-request-to-scope-update.svg)
...
- `scope_update` → process step candidate
...
bp:changerequesttoscopeupdate a ng:BusinessProcessPattern ;
  ng:processId "BP-115" ;
  ng:domain "Projects & Services" ;
  rdfs:label "Change Request to Scope Update" .
```
