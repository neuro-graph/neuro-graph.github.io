---
title: Service Delivery to Confirmation
category: Projects & Services
processId: BP-112
---

# Service Delivery to Confirmation
...
![Service Delivery to Confirmation workflow](./diagrams/service-delivery-to-confirmation.svg)

## Primary workflow

| Step | Workflow stage | Suggested RDF role |
|---:|---|---|
| 1 | Service Delivery | `service_delivery` |
...
- `service_delivery` → process step candidate
...
bp:servicedeliverytoconfirmation a ng:BusinessProcessPattern ;
  ng:processId "BP-112" ;
  ng:domain "Projects & Services" ;
  rdfs:label "Service Delivery to Confirmation" .
```
