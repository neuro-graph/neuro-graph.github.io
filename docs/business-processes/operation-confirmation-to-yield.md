---
title: Operation Confirmation to Yield
category: Manufacturing & Operations
processId: BP-059
---

# Operation Confirmation to Yield
...
![Operation Confirmation to Yield workflow](./diagrams/operation-confirmation-to-yield.svg)

## Primary workflow

| Step | Workflow stage | Suggested RDF role |
|---:|---|---|
| 1 | Operation Confirmation | `operation_confirmation` |
...
- `operation_confirmation` → process step candidate
...
bp:operationconfirmationtoyield a ng:BusinessProcessPattern ;
  ng:processId "BP-059" ;
  ng:domain "Manufacturing & Operations" ;
  rdfs:label "Operation Confirmation to Yield" .
```
