---
title: Outbound Delivery to Goods Issue
category: Inventory & Logistics
processId: BP-039
---

# Outbound Delivery to Goods Issue
...
![Outbound Delivery to Goods Issue workflow](./diagrams/outbound-delivery-to-goods-issue.svg)

## Primary workflow

| Step | Workflow stage | Suggested RDF role |
|---:|---|---|
| 1 | Outbound Delivery | `outbound_delivery` |
...
- `outbound_delivery` → process step candidate
...
- `goods_issue` → process step candidate
...
bp:outbounddeliverytogoodsissue a ng:BusinessProcessPattern ;
  ng:processId "BP-039" ;
  ng:domain "Inventory & Logistics" ;
  rdfs:label "Outbound Delivery to Goods Issue" .
```
