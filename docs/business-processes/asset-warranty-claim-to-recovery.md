---
title: Asset Warranty Claim to Recovery
category: Assets & Maintenance
processId: BP-103
---

# Asset Warranty Claim to Recovery
...
![Asset Warranty Claim to Recovery workflow](./diagrams/asset-warranty-claim-to-recovery.svg)

## Primary workflow

| Step | Workflow stage | Suggested RDF role |
|---:|---|---|
| 1 | Asset Warranty Claim | `asset_warranty_claim` |
...
- `asset_warranty_claim` → process step candidate
...
bp:assetwarrantyclaimtorecovery a ng:BusinessProcessPattern ;
  ng:processId "BP-103" ;
  ng:domain "Assets & Maintenance" ;
  rdfs:label "Asset Warranty Claim to Recovery" .
```
