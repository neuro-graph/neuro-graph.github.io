---
title: Asset Transfer to Retirement
category: Finance & Controlling
processId: BP-086
---

# Asset Transfer to Retirement
...
![Asset Transfer to Retirement workflow](./diagrams/asset-transfer-to-retirement.svg)

## Primary workflow

| Step | Workflow stage | Suggested RDF role |
|---:|---|---|
| 1 | Asset Transfer | `asset_transfer` |
...
- `asset_transfer` → process step candidate
...
- `retirement` → process step candidate
...
bp:assettransfertoretirement a ng:BusinessProcessPattern ;
  ng:processId "BP-086" ;
  ng:domain "Finance & Controlling" ;
  rdfs:label "Asset Transfer to Retirement" .
```
