---
title: Inbound Delivery to Putaway
category: Inventory & Logistics
processId: BP-038
---

# Inbound Delivery to Putaway
...
![Inbound Delivery to Putaway workflow](./diagrams/inbound-delivery-to-putaway.svg)

## Primary workflow

| Step | Workflow stage | Suggested RDF role |
|---:|---|---|
| 1 | Inbound Delivery | `inbound_delivery` |
...
- `inbound_delivery` → process step candidate
...
- `putaway` → process step candidate
...
bp:inbounddeliverytoputaway a ng:BusinessProcessPattern ;
  ng:processId "BP-038" ;
  ng:domain "Inventory & Logistics" ;
  rdfs:label "Inbound Delivery to Putaway" .
```
