---
title: Supply Plan to Production Proposal
category: Planning & Supply Chain
processId: BP-132
---

# Supply Plan to Production Proposal
...
![Supply Plan to Production Proposal workflow](./diagrams/supply-plan-to-production-proposal.svg)
...
| 6 | Production Proposal | `production_proposal` |
...
- `production_proposal` → process step candidate
...
bp:supplyplantoproductionproposal a ng:BusinessProcessPattern ;
  ng:processId "BP-132" ;
  ng:domain "Planning & Supply Chain" ;
  rdfs:label "Supply Plan to Production Proposal" .
```
