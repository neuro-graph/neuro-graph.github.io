---
title: Journal Entry Request to Posting
category: Finance & Controlling
processId: BP-073
---

# Journal Entry Request to Posting
...
![Journal Entry Request to Posting workflow](./diagrams/journal-entry-request-to-posting.svg)

## Primary workflow

| Step | Workflow stage | Suggested RDF role |
|---:|---|---|
| 1 | Journal Entry Request | `journal_entry_request` |
...
- `journal_entry_request` → process step candidate
...
- `posting` → process step candidate
...
bp:journalentryrequesttoposting a ng:BusinessProcessPattern ;
  ng:processId "BP-073" ;
  ng:domain "Finance & Controlling" ;
  rdfs:label "Journal Entry Request to Posting" .
```
