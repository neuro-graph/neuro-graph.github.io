---
title: Employee Master Data Change to Approval
category: Workforce & HR
processId: BP-122
---

# Employee Master Data Change to Approval
...
![Employee Master Data Change to Approval workflow](./diagrams/employee-master-data-change-to-approval.svg)

## Primary workflow

| Step | Workflow stage | Suggested RDF role |
|---:|---|---|
| 1 | Employee Master Data Change | `employee_master_data_change` |
...
- `employee_master_data_change` → process step candidate
...
bp:employeemasterdatachangetoapproval a ng:BusinessProcessPattern ;
  ng:processId "BP-122" ;
  ng:domain "Workforce & HR" ;
  rdfs:label "Employee Master Data Change to Approval" .
```
