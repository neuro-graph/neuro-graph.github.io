---
title: Co Product Allocation to Costing
category: Manufacturing & Operations
processId: BP-071
---

# Co Product Allocation to Costing
...
![Co Product Allocation to Costing workflow](./diagrams/co-product-allocation-to-costing.svg)

## Primary workflow

| Step | Workflow stage | Suggested RDF role |
|---:|---|---|
| 1 | Co Product Allocation | `co_product_allocation` |
...
- `co_product_allocation` → process step candidate
...
- `costing` → process step candidate
...
bp:coproductallocationtocosting a ng:BusinessProcessPattern ;
  ng:processId "BP-071" ;
  ng:domain "Manufacturing & Operations" ;
  rdfs:label "Co Product Allocation to Costing" .
```
