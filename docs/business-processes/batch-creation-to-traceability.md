---
title: Batch Creation to Traceability
category: Inventory & Logistics
processId: BP-044
---

# Batch Creation to Traceability
...
![Batch Creation to Traceability workflow](./diagrams/batch-creation-to-traceability.svg)

## Primary workflow

| Step | Workflow stage | Suggested RDF role |
|---:|---|---|
| 1 | Batch Creation | `batch_creation` |
...
- `batch_creation` → process step candidate
...
- `traceability` → process step candidate
...
bp:batchcreationtotraceability a ng:BusinessProcessPattern ;
  ng:processId "BP-044" ;
  ng:domain "Inventory & Logistics" ;
  rdfs:label "Batch Creation to Traceability" .
```
