---
title: Outgoing Payment to Bank Statement
category: Finance & Controlling
processId: BP-078
---

# Outgoing Payment to Bank Statement
...
![Outgoing Payment to Bank Statement workflow](./diagrams/outgoing-payment-to-bank-statement.svg)

## Primary workflow

| Step | Workflow stage | Suggested RDF role |
|---:|---|---|
| 1 | Outgoing Payment | `outgoing_payment` |
...
| 6 | Bank Statement | `bank_statement` |
...
- `outgoing_payment` → process step candidate
...
- `bank_statement` → process step candidate
...
bp:outgoingpaymenttobankstatement a ng:BusinessProcessPattern ;
  ng:processId "BP-078" ;
  ng:domain "Finance & Controlling" ;
  rdfs:label "Outgoing Payment to Bank Statement" .
```
