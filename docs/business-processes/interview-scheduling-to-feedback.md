---
title: Interview Scheduling to Feedback
category: Workforce & HR
processId: BP-119
---

# Interview Scheduling to Feedback
...
![Interview Scheduling to Feedback workflow](./diagrams/interview-scheduling-to-feedback.svg)

## Primary workflow

| Step | Workflow stage | Suggested RDF role |
|---:|---|---|
| 1 | Interview Scheduling | `interview_scheduling` |
...
- `interview_scheduling` → process step candidate
...
- `feedback` → process step candidate
...
bp:interviewschedulingtofeedback a ng:BusinessProcessPattern ;
  ng:processId "BP-119" ;
  ng:domain "Workforce & HR" ;
  rdfs:label "Interview Scheduling to Feedback" .
```
