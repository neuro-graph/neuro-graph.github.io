---
title: Work Order Planning to Release
category: Assets & Maintenance
processId: BP-095
---

# Work Order Planning to Release
...
![Work Order Planning to Release workflow](./diagrams/work-order-planning-to-release.svg)

## Primary workflow

| Step | Workflow stage | Suggested RDF role |
|---:|---|---|
| 1 | Work Order Planning | `work_order_planning` |
...
- `work_order_planning` → process step candidate
...
bp:workorderplanningtorelease a ng:BusinessProcessPattern ;
  ng:processId "BP-095" ;
  ng:domain "Assets & Maintenance" ;
  rdfs:label "Work Order Planning to Release" .
```
