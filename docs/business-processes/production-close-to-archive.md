---
title: Production Close to Archive
category: Manufacturing & Operations
processId: BP-072
---

# Production Close to Archive
...
![Production Close to Archive workflow](./diagrams/production-close-to-archive.svg)

## Primary workflow

| Step | Workflow stage | Suggested RDF role |
|---:|---|---|
| 1 | Production Close | `production_close` |
...
- `production_close` → process step candidate
...
bp:productionclosetoarchive a ng:BusinessProcessPattern ;
  ng:processId "BP-072" ;
  ng:domain "Manufacturing & Operations" ;
  rdfs:label "Production Close to Archive" .
```
