---
title: Usage Capture to Billing
category: Customer & Revenue
processId: BP-014
---

# Usage Capture to Billing
...
![Usage Capture to Billing workflow](./diagrams/usage-capture-to-billing.svg)

## Primary workflow

| Step | Workflow stage | Suggested RDF role |
|---:|---|---|
| 1 | Usage Capture | `usage_capture` |
...
- `usage_capture` → process step candidate
...
bp:usagecapturetobilling a ng:BusinessProcessPattern ;
  ng:processId "BP-014" ;
  ng:domain "Customer & Revenue" ;
  rdfs:label "Usage Capture to Billing" .
```
