---
title: Work Package Assignment to Execution
category: Projects & Services
processId: BP-107
---

# Work Package Assignment to Execution
...
![Work Package Assignment to Execution workflow](./diagrams/work-package-assignment-to-execution.svg)

## Primary workflow

| Step | Workflow stage | Suggested RDF role |
|---:|---|---|
| 1 | Work Package Assignment | `work_package_assignment` |
...
- `work_package_assignment` → process step candidate
...
- `execution` → process step candidate
...
bp:workpackageassignmenttoexecution a ng:BusinessProcessPattern ;
  ng:processId "BP-107" ;
  ng:domain "Projects & Services" ;
  rdfs:label "Work Package Assignment to Execution" .
```
