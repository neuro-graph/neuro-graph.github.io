---
title: Shipment Planning to Dispatch
category: Inventory & Logistics
processId: BP-049
---

# Shipment Planning to Dispatch
...
![Shipment Planning to Dispatch workflow](./diagrams/shipment-planning-to-dispatch.svg)

## Primary workflow

| Step | Workflow stage | Suggested RDF role |
|---:|---|---|
| 1 | Shipment Planning | `shipment_planning` |
...
- `shipment_planning` → process step candidate
...
bp:shipmentplanningtodispatch a ng:BusinessProcessPattern ;
  ng:processId "BP-049" ;
  ng:domain "Inventory & Logistics" ;
  rdfs:label "Shipment Planning to Dispatch" .
```
