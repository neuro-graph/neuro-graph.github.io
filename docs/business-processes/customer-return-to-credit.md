---
title: Customer Return to Credit
...
![Customer Return to Credit workflow](./diagrams/customer-return-to-credit.svg)

## Primary workflow

| Step | Workflow stage | Suggested RDF role |
|---:|---|---|
| 1 | Customer Return | `customer_return` |
...
- `customer_return` → process step candidate
...
bp:customerreturntocredit a ng:BusinessProcessPattern ;
  ng:processId "BP-010" ;
  ng:domain "Customer & Revenue" ;
  rdfs:label "Customer Return to Credit" .
```
