---
title: Lead Capture to Qualification
...
![Lead Capture to Qualification workflow](./diagrams/lead-capture-to-qualification.svg)
...
- `lead_capture` → process step candidate
...
bp:leadcapturetoqualification a ng:BusinessProcessPattern ;
  ng:processId "BP-001" ;
  ng:domain "Customer & Revenue" ;
  rdfs:label "Lead Capture to Qualification" .
```
