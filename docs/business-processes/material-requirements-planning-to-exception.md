---
title: Material Requirements Planning to Exception
category: Planning & Supply Chain
processId: BP-134
---

# Material Requirements Planning to Exception
...
![Material Requirements Planning to Exception workflow](./diagrams/material-requirements-planning-to-exception.svg)

## Primary workflow

| Step | Workflow stage | Suggested RDF role |
|---:|---|---|
| 1 | Material Requirements Planning | `material_requirements_planning` |
...
- `material_requirements_planning` → process step candidate
...
bp:materialrequirementsplanningtoexception a ng:BusinessProcessPattern ;
  ng:processId "BP-134" ;
  ng:domain "Planning & Supply Chain" ;
  rdfs:label "Material Requirements Planning to Exception" .
```
