---
title: Subscription Activation to Renewal
category: Customer & Revenue
processId: BP-013
---

# Subscription Activation to Renewal
...
![Subscription Activation to Renewal workflow](./diagrams/subscription-activation-to-renewal.svg)

## Primary workflow

| Step | Workflow stage | Suggested RDF role |
|---:|---|---|
| 1 | Subscription Activation | `subscription_activation` |
...
- `subscription_activation` → process step candidate
...
- `renewal` → process step candidate
...
bp:subscriptionactivationtorenewal a ng:BusinessProcessPattern ;
  ng:processId "BP-013" ;
  ng:domain "Customer & Revenue" ;
  rdfs:label "Subscription Activation to Renewal" .
```
