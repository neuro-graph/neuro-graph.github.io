...
![Picking to Packing workflow](./diagrams/picking-to-packing.svg)
...
- `picking` → process step candidate
...
bp:pickingtopacking a ng:BusinessProcessPattern ;
  ng:processId "BP-047" ;
  ng:domain "Inventory & Logistics" ;
  rdfs:label "Picking to Packing" .
```
