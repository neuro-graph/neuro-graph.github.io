---
title: Profit Center Posting to Reporting
category: Finance & Controlling
processId: BP-082
---

# Profit Center Posting to Reporting
...
![Profit Center Posting to Reporting workflow](./diagrams/profit-center-posting-to-reporting.svg)

## Primary workflow

| Step | Workflow stage | Suggested RDF role |
|---:|---|---|
| 1 | Profit Center Posting | `profit_center_posting` |
...
- `profit_center_posting` → process step candidate
...
- `reporting` → process step candidate
...
bp:profitcenterpostingtoreporting a ng:BusinessProcessPattern ;
  ng:processId "BP-082" ;
  ng:domain "Finance & Controlling" ;
  rdfs:label "Profit Center Posting to Reporting" .
```
