...
![Purchase Order to Goods Receipt workflow](./diagrams/purchase-order-to-goods-receipt.svg)

## Primary workflow

| Step | Workflow stage | Suggested RDF role |
|---:|---|---|
| 1 | Purchase Order | `purchase_order` |
...
bp:purchaseordertogoodsreceipt a ng:BusinessProcessPattern ;
  ng:processId "BP-025" ;
  ng:domain "Procurement & Supplier" ;
  rdfs:label "Purchase Order to Goods Receipt" .
```
