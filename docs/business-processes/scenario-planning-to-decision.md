---
title: Scenario Planning to Decision
category: Planning & Supply Chain
processId: BP-138
---

# Scenario Planning to Decision
...
![Scenario Planning to Decision workflow](./diagrams/scenario-planning-to-decision.svg)

## Primary workflow

| Step | Workflow stage | Suggested RDF role |
|---:|---|---|
| 1 | Scenario Planning | `scenario_planning` |
...
- `scenario_planning` → process step candidate
...
- `decision` → process step candidate
...
bp:scenarioplanningtodecision a ng:BusinessProcessPattern ;
  ng:processId "BP-138" ;
  ng:domain "Planning & Supply Chain" ;
  rdfs:label "Scenario Planning to Decision" .
```
