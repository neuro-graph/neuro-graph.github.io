---
title: Freight Cost Capture to Settlement
category: Inventory & Logistics
processId: BP-051
---

# Freight Cost Capture to Settlement
...
![Freight Cost Capture to Settlement workflow](./diagrams/freight-cost-capture-to-settlement.svg)

## Primary workflow

| Step | Workflow stage | Suggested RDF role |
|---:|---|---|
| 1 | Freight Cost Capture | `freight_cost_capture` |
...
- `freight_cost_capture` → process step candidate
...
bp:freightcostcapturetosettlement a ng:BusinessProcessPattern ;
  ng:processId "BP-051" ;
  ng:domain "Inventory & Logistics" ;
  rdfs:label "Freight Cost Capture to Settlement" .
```
