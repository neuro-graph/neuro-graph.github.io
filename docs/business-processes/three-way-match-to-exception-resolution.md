---
title: Three Way Match to Exception Resolution
category: Procurement & Supplier
processId: BP-028
---

# Three Way Match to Exception Resolution
...
![Three Way Match to Exception Resolution workflow](./diagrams/three-way-match-to-exception-resolution.svg)

## Primary workflow

| Step | Workflow stage | Suggested RDF role |
|---:|---|---|
| 1 | Three Way Match | `three_way_match` |
...
| 6 | Exception Resolution | `exception_resolution` |
...
- `three_way_match` → process step candidate
...
- `exception_resolution` → process step candidate
...
bp:threewaymatchtoexceptionresolution a ng:BusinessProcessPattern ;
  ng:processId "BP-028" ;
  ng:domain "Procurement & Supplier" ;
  rdfs:label "Three Way Match to Exception Resolution" .
```
