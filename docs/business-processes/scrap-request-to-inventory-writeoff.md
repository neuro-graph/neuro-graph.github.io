---
title: Scrap Request to Inventory Writeoff
category: Inventory & Logistics
processId: BP-053
---

# Scrap Request to Inventory Writeoff
...
![Scrap Request to Inventory Writeoff workflow](./diagrams/scrap-request-to-inventory-writeoff.svg)

## Primary workflow

| Step | Workflow stage | Suggested RDF role |
|---:|---|---|
| 1 | Scrap Request | `scrap_request` |
...
| 6 | Inventory Writeoff | `inventory_writeoff` |
...
- `scrap_request` → process step candidate
...
- `inventory_writeoff` → process step candidate
...
bp:scraprequesttoinventorywriteoff a ng:BusinessProcessPattern ;
  ng:processId "BP-053" ;
  ng:domain "Inventory & Logistics" ;
  rdfs:label "Scrap Request to Inventory Writeoff" .
```
