---
title: Time Recording to Approval
category: Workforce & HR
processId: BP-123
---

# Time Recording to Approval
...
![Time Recording to Approval workflow](./diagrams/time-recording-to-approval.svg)

## Primary workflow

| Step | Workflow stage | Suggested RDF role |
|---:|---|---|
| 1 | Time Recording | `time_recording` |
...
- `time_recording` → process step candidate
...
bp:timerecordingtoapproval a ng:BusinessProcessPattern ;
  ng:processId "BP-123" ;
  ng:domain "Workforce & HR" ;
  rdfs:label "Time Recording to Approval" .
```
