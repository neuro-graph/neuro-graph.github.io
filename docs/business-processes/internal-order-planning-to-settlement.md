---
title: Internal Order Planning to Settlement
category: Finance & Controlling
processId: BP-083
---

# Internal Order Planning to Settlement
...
![Internal Order Planning to Settlement workflow](./diagrams/internal-order-planning-to-settlement.svg)

## Primary workflow

| Step | Workflow stage | Suggested RDF role |
|---:|---|---|
| 1 | Internal Order Planning | `internal_order_planning` |
...
- `internal_order_planning` → process step candidate
...
bp:internalorderplanningtosettlement a ng:BusinessProcessPattern ;
  ng:processId "BP-083" ;
  ng:domain "Finance & Controlling" ;
  rdfs:label "Internal Order Planning to Settlement" .
```
