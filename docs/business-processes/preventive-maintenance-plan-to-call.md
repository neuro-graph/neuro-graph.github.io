---
title: Preventive Maintenance Plan to Call
category: Assets & Maintenance
processId: BP-099
---

# Preventive Maintenance Plan to Call
...
![Preventive Maintenance Plan to Call workflow](./diagrams/preventive-maintenance-plan-to-call.svg)

## Primary workflow

| Step | Workflow stage | Suggested RDF role |
|---:|---|---|
| 1 | Preventive Maintenance Plan | `preventive_maintenance_plan` |
...
- `preventive_maintenance_plan` → process step candidate
...
bp:preventivemaintenanceplantocall a ng:BusinessProcessPattern ;
  ng:processId "BP-099" ;
  ng:domain "Assets & Maintenance" ;
  rdfs:label "Preventive Maintenance Plan to Call" .
```
