---
title: Offer Creation to Acceptance
category: Workforce & HR
processId: BP-120
---

# Offer Creation to Acceptance
...
![Offer Creation to Acceptance workflow](./diagrams/offer-creation-to-acceptance.svg)

## Primary workflow

| Step | Workflow stage | Suggested RDF role |
|---:|---|---|
| 1 | Offer Creation | `offer_creation` |
...
- `offer_creation` → process step candidate
...
- `acceptance` → process step candidate
...
bp:offercreationtoacceptance a ng:BusinessProcessPattern ;
  ng:processId "BP-120" ;
  ng:domain "Workforce & HR" ;
  rdfs:label "Offer Creation to Acceptance" .
```
