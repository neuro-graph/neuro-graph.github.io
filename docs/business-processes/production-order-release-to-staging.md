---
title: Production Order Release to Staging
category: Manufacturing & Operations
processId: BP-057
---

# Production Order Release to Staging
...
![Production Order Release to Staging workflow](./diagrams/production-order-release-to-staging.svg)

## Primary workflow

| Step | Workflow stage | Suggested RDF role |
|---:|---|---|
| 1 | Production Order Release | `production_order_release` |
...
- `production_order_release` → process step candidate
...
- `staging` → process step candidate
...
bp:productionorderreleasetostaging a ng:BusinessProcessPattern ;
  ng:processId "BP-057" ;
  ng:domain "Manufacturing & Operations" ;
  rdfs:label "Production Order Release to Staging" .
```
