...
![Packing to Shipment workflow](./diagrams/packing-to-shipment.svg)
...
- `packing` → process step candidate
...
- `shipment` → process step candidate
...
bp:packingtoshipment a ng:BusinessProcessPattern ;
  ng:processId "BP-048" ;
  ng:domain "Inventory & Logistics" ;
  rdfs:label "Packing to Shipment" .
```
