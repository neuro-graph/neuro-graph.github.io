---
title: Customer Onboarding to Account Activation
category: Customer & Revenue
processId: BP-016
---

# Customer Onboarding to Account Activation
...
![Customer Onboarding to Account Activation workflow](./diagrams/customer-onboarding-to-account-activation.svg)

## Primary workflow

| Step | Workflow stage | Suggested RDF role |
|---:|---|---|
| 1 | Customer Onboarding | `customer_onboarding` |
...
| 6 | Account Activation | `account_activation` |
...
- `customer_onboarding` → process step candidate
...
- `account_activation` → process step candidate
...
bp:customeronboardingtoaccountactivation a ng:BusinessProcessPattern ;
  ng:processId "BP-016" ;
  ng:domain "Customer & Revenue" ;
  rdfs:label "Customer Onboarding to Account Activation" .
```
