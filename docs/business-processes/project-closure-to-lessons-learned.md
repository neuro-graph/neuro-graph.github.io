---
title: Project Closure to Lessons Learned
category: Projects & Services
processId: BP-116
---

# Project Closure to Lessons Learned
...
![Project Closure to Lessons Learned workflow](./diagrams/project-closure-to-lessons-learned.svg)

## Primary workflow

| Step | Workflow stage | Suggested RDF role |
|---:|---|---|
| 1 | Project Closure | `project_closure` |
...
- `project_closure` → process step candidate
...
- `lessons_learned` → process step candidate
...
bp:projectclosuretolessonslearned a ng:BusinessProcessPattern ;
  ng:processId "BP-116" ;
  ng:domain "Projects & Services" ;
  rdfs:label "Project Closure to Lessons Learned" .
```
