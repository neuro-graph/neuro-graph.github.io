---
title: Expense Claim to Reimbursement
...
![Expense Claim to Reimbursement workflow](./diagrams/expense-claim-to-reimbursement.svg)

## Primary workflow

| Step | Workflow stage | Suggested RDF role |
|---:|---|---|
| 1 | Expense Claim | `expense_claim` |
...
- `expense_claim` → process step candidate
...
- `reimbursement` → process step candidate
...
bp:expenseclaimtoreimbursement a ng:BusinessProcessPattern ;
  ng:processId "BP-080" ;
  ng:domain "Finance & Controlling" ;
  rdfs:label "Expense Claim to Reimbursement" .
```
