---
title: Strategic Plan to Demand Forecast
category: Planning & Supply Chain
processId: BP-129
---

# Strategic Plan to Demand Forecast
...
![Strategic Plan to Demand Forecast workflow](./diagrams/strategic-plan-to-demand-forecast.svg)

## Primary workflow

| Step | Workflow stage | Suggested RDF role |
|---:|---|---|
| 1 | Strategic Plan | `strategic_plan` |
...
| 6 | Demand Forecast | `demand_forecast` |
...
- `strategic_plan` → process step candidate
...
- `demand_forecast` → process step candidate
...
bp:strategicplantodemandforecast a ng:BusinessProcessPattern ;
  ng:processId "BP-129" ;
  ng:domain "Planning & Supply Chain" ;
  rdfs:label "Strategic Plan to Demand Forecast" .
```
