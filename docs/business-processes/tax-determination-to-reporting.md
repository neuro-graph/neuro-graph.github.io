---
title: Tax Determination to Reporting
category: Finance & Controlling
processId: BP-091
---

# Tax Determination to Reporting
...
![Tax Determination to Reporting workflow](./diagrams/tax-determination-to-reporting.svg)

## Primary workflow

| Step | Workflow stage | Suggested RDF role |
|---:|---|---|
| 1 | Tax Determination | `tax_determination` |
...
- `tax_determination` → process step candidate
...
bp:taxdeterminationtoreporting a ng:BusinessProcessPattern ;
  ng:processId "BP-091" ;
  ng:domain "Finance & Controlling" ;
  rdfs:label "Tax Determination to Reporting" .
```
