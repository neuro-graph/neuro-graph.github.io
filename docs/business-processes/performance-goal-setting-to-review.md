---
title: Performance Goal Setting to Review
category: Workforce & HR
processId: BP-126
---

# Performance Goal Setting to Review
...
![Performance Goal Setting to Review workflow](./diagrams/performance-goal-setting-to-review.svg)

## Primary workflow

| Step | Workflow stage | Suggested RDF role |
|---:|---|---|
| 1 | Performance Goal Setting | `performance_goal_setting` |
...
- `performance_goal_setting` → process step candidate
...
bp:performancegoalsettingtoreview a ng:BusinessProcessPattern ;
  ng:processId "BP-126" ;
  ng:domain "Workforce & HR" ;
  rdfs:label "Performance Goal Setting to Review" .
```
