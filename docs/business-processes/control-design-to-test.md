---
title: Control Design to Test
category: Governance Risk Data
processId: BP-142
---

# Control Design to Test
...
![Control Design to Test workflow](./diagrams/control-design-to-test.svg)

## Primary workflow

| Step | Workflow stage | Suggested RDF role |
|---:|---|---|
| 1 | Control Design | `control_design` |
...
- `control_design` → process step candidate
...
bp:controldesigntotest a ng:BusinessProcessPattern ;
  ng:processId "BP-142" ;
  ng:domain "Governance Risk Data" ;
  rdfs:label "Control Design to Test" .
```
