---
title: Bill of Material Change to Release
category: Manufacturing & Operations
processId: BP-065
---

# Bill of Material Change to Release
...
![Bill of Material Change to Release workflow](./diagrams/bill-of-material-change-to-release.svg)

## Primary workflow

| Step | Workflow stage | Suggested RDF role |
|---:|---|---|
| 1 | Bill of Material Change | `bill_of_material_change` |
...
- `bill_of_material_change` → process step candidate
...
bp:billofmaterialchangetorelease a ng:BusinessProcessPattern ;
  ng:processId "BP-065" ;
  ng:domain "Manufacturing & Operations" ;
  rdfs:label "Bill of Material Change to Release" .
```
