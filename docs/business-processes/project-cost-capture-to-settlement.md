---
title: Project Cost Capture to Settlement
category: Projects & Services
processId: BP-114
---

# Project Cost Capture to Settlement
...
![Project Cost Capture to Settlement workflow](./diagrams/project-cost-capture-to-settlement.svg)

## Primary workflow

| Step | Workflow stage | Suggested RDF role |
|---:|---|---|
| 1 | Project Cost Capture | `project_cost_capture` |
...
- `project_cost_capture` → process step candidate
...
bp:projectcostcapturetosettlement a ng:BusinessProcessPattern ;
  ng:processId "BP-114" ;
  ng:domain "Projects & Services" ;
  rdfs:label "Project Cost Capture to Settlement" .
```
