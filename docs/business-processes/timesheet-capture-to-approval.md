---
title: Timesheet Capture to Approval
category: Projects & Services
processId: BP-108
---

# Timesheet Capture to Approval
...
![Timesheet Capture to Approval workflow](./diagrams/timesheet-capture-to-approval.svg)

## Primary workflow

| Step | Workflow stage | Suggested RDF role |
|---:|---|---|
| 1 | Timesheet Capture | `timesheet_capture` |
...
- `timesheet_capture` → process step candidate
...
bp:timesheetcapturetoapproval a ng:BusinessProcessPattern ;
  ng:processId "BP-108" ;
  ng:domain "Projects & Services" ;
  rdfs:label "Timesheet Capture to Approval" .
```
