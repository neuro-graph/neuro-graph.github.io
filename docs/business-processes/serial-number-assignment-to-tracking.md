---
title: Serial Number Assignment to Tracking
category: Inventory & Logistics
processId: BP-045
---

# Serial Number Assignment to Tracking
...
![Serial Number Assignment to Tracking workflow](./diagrams/serial-number-assignment-to-tracking.svg)

## Primary workflow

| Step | Workflow stage | Suggested RDF role |
|---:|---|---|
| 1 | Serial Number Assignment | `serial_number_assignment` |
...
- `serial_number_assignment` → process step candidate
...
- `tracking` → process step candidate
...
bp:serialnumberassignmenttotracking a ng:BusinessProcessPattern ;
  ng:processId "BP-045" ;
  ng:domain "Inventory & Logistics" ;
  rdfs:label "Serial Number Assignment to Tracking" .
```
