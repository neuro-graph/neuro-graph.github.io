...
![Demand Forecast to Supply Plan workflow](./diagrams/demand-forecast-to-supply-plan.svg)

## Primary workflow

| Step | Workflow stage | Suggested RDF role |
|---:|---|---|
| 1 | Demand Forecast | `demand_forecast` |
...
bp:demandforecasttosupplyplan a ng:BusinessProcessPattern ;
  ng:processId "BP-130" ;
  ng:domain "Planning & Supply Chain" ;
  rdfs:label "Demand Forecast to Supply Plan" .
```
