---
title: Material Staging to Consumption
category: Manufacturing & Operations
processId: BP-058
---

# Material Staging to Consumption
...
![Material Staging to Consumption workflow](./diagrams/material-staging-to-consumption.svg)

## Primary workflow

| Step | Workflow stage | Suggested RDF role |
|---:|---|---|
| 1 | Material Staging | `material_staging` |
...
- `material_staging` → process step candidate
...
- `consumption` → process step candidate
...
bp:materialstagingtoconsumption a ng:BusinessProcessPattern ;
  ng:processId "BP-058" ;
  ng:domain "Manufacturing & Operations" ;
  rdfs:label "Material Staging to Consumption" .
```
