---
title: Asset Depreciation to Posting
category: Finance & Controlling
processId: BP-085
---

# Asset Depreciation to Posting
...
![Asset Depreciation to Posting workflow](./diagrams/asset-depreciation-to-posting.svg)

## Primary workflow

| Step | Workflow stage | Suggested RDF role |
|---:|---|---|
| 1 | Asset Depreciation | `asset_depreciation` |
...
- `asset_depreciation` → process step candidate
...
bp:assetdepreciationtoposting a ng:BusinessProcessPattern ;
  ng:processId "BP-085" ;
  ng:domain "Finance & Controlling" ;
  rdfs:label "Asset Depreciation to Posting" .
```
