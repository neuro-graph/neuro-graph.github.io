---
title: Import Procurement to Landed Cost
category: Procurement & Supplier
processId: BP-034
---

# Import Procurement to Landed Cost
...
![Import Procurement to Landed Cost workflow](./diagrams/import-procurement-to-landed-cost.svg)

## Primary workflow

| Step | Workflow stage | Suggested RDF role |
|---:|---|---|
| 1 | Import Procurement | `import_procurement` |
...
- `import_procurement` → process step candidate
...
- `landed_cost` → process step candidate
...
bp:importprocurementtolandedcost a ng:BusinessProcessPattern ;
  ng:processId "BP-034" ;
  ng:domain "Procurement & Supplier" ;
  rdfs:label "Import Procurement to Landed Cost" .
```
